...
<template>
  <div v-if="showEditModal" class="fixed z-10 inset-0 overflow-y-auto flex items-center justify-center bg-slate-500">
    <div class="bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-70% flex flex-col p-6 overflow-y-auto max-h-screen" style="min-width: 50%">
          ...
          <div class="text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow">
            <h3 class="text-lg leading-6 font-medium text-gray-900">
              ...
              <label for="status-description" class="label mt-4">
                <span class="label-text text-2xl font-bold text-pink-400">Description</span>
              </label>
              <textarea id="status-description" v-model="selectedStatus.statusDescription" class="textarea textarea-bordered w-full h-24 rounded-lg textarea-md text-lg bg-gray-200 mt-2" placeholder="Description"></textarea>
